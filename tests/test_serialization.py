import pytest
from keriac.domain import SAID, PublicKey, Signature, DataRecord
from keriac.logbook.entries import Event, InteractionEvent
...
@pytest.mark.parametrize("cls, qb64", [
    ...
    # Ed25519 Sig ('A')
    (Signature, "CABoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGhoaGho"),
    # ECDSA Sig ('C')
])
